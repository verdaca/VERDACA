"""Adapter-internal test — LiteLLMAdapter api_base override routing.
...
`litellm.completion()`. NOT part of the shared 7-ID-frozen contract
suite (`tests/src/praxis/contract_tests/ports/test_llm_proxy_contract.py`)
